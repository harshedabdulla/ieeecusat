...
function Execom() {
  ...
  <div className="flex flex-wrap justify-center lg:-mx-4 md:-mx-2">
    ...
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
      <Card imgSrc={Aman} name="Aman" position="IAS Secretory" ieeeno="S5 ECE" />
    </div>
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
  ...
  <h3 className="text-4xl text-center font-bold p-4 mb-4">Outreach Team</h3>
  <div className="flex flex-wrap justify-center lg:-mx-4 md:-mx-2">
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
  ...
  <h3 className="text-4xl text-center font-bold p-4 mb-4">Content Team</h3>
  <div className="flex flex-wrap justify-center lg:-mx-4 md:-mx-2">
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
      <Card imgSrc={Ghaada} name="Ghaada Sideeque" position="Content Head" ieeeno="S5 CSE" />
    </div>
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
  ...
  <div className="flex flex-wrap justify-center lg:-mx-4 md:-mx-2">
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
      <Card imgSrc={Ajmal} name="Ajmal Roshan" position="" ieeeno="S5 CSE" />
    </div>
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
      <Card imgSrc={Harshed} name="Harshed Abdulla" position="" ieeeno="S5 ECE" />
    </div>
    <div className="w-full lg:w-1/3 lg:px-4 md:w-1/2 md:px-2 mb-8">
