...
const Cards2 = ({ imageSrc, name, profession, institution, connectLink }) => {
  return (
    <div className='w-[240px] h-[240px] bg-transparent cursor-pointer group perspective'>
      <div className='relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000'>
        <div className='absolute backface-hidden border-2 w-full h-full'>
          <img src={imageSrc} alt={name} className='w-full h-full' />
        </div>
        <div className='absolute my-rotate-y-180 backface-hidden w-full h-full bg-blue-900 overflow-hidden'>
